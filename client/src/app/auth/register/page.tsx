  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (axios.isAxiosError(err)) {
        setError(err.response?.data?.message || err.response?.data?.error || "We couldn't create your account. Please try again.");
      } else {
